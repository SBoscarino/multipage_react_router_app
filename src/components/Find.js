  ...
  render(){
    ...
    <div className="find">
      ...
      <div className="sub-header">
        <h2>Hey, folks. How about we socialize?</h2>
      </div>

      <div className="contact-area">
        <div className="map">
          <p>Here is a cool place. It is where I am from. You should adopt cats from there.</p>
          <iframe height="400px"   src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13389.515740959312!2d-96.847438!3d32.967403!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x7e75dae634dfb655!2sOperation+Kindness!5e0!3m2!1sen!2sus!4v1504129290731
